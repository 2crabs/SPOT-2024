...
public class SpeakerTwoNoteAuto extends SequentialCommandGroup {
  private IntakeSubsystem m_intakeSubsystem;
  private IndexerSubsystem m_indexerSubsystem;
  private ShooterSubsystem m_shooterSubsystem;
  private SwerveDrive m_swerveDrive;
  /** Creates a new SpeakerAuto. */
  public SpeakerTwoNoteAuto(IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, SwerveDrive drive) {
    ...
    addCommands(
      ...
      .andThen(new ParallelCommandGroup(
        ...
        new RunCommand(() -> m_swerveDrive.basicDrive(0.8, 0.0, 0.0, false), m_swerveDrive)
      ).withTimeout(1.6)
      .andThen(new ParallelCommandGroup(new RunCommand(() -> m_swerveDrive.basicDrive(-0.8, 0.0, 0.0, false), m_swerveDrive), 
